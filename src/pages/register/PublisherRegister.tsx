...
type RegisterForm = z.infer<typeof publisherRegisterSchema>;
...
export default function PublisherRegister() {
  ...
  const {
    ...
    resolver: zodResolver(publisherRegisterSchema),
  });
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-light via-background to-accent-light">
      ...
      <div className="flex items-center justify-center p-4 min-h-[calc(100vh-80px)]">
        ...
        <CardHeader className="space-y-4 text-center">
          ...
          <CardTitle className="text-3xl font-bold">Publisher Registration</CardTitle>
          <CardDescription>Join EduConnect as a publisher</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Upload a government registration or license (JPG/PNG, max 5MB).
              </p>
              {fileError && <p className="text-sm text-destructive">{fileError}</p>}
            </div>

            <div className="space-y-2">
              <Label htmlFor="organizationName">Publishing House Name</Label>
              <Input
                id="organizationName"
